...
tf.app.flags.DEFINE_string('VOC_dir', '/mnt/USBC/gx/Detection/', 'Voc dir')
tf.app.flags.DEFINE_string('xml_dir', 'WIDER_XML', 'xml dir')
tf.app.flags.DEFINE_string('image_dir', 'WIDER_JPG', 'image dir')
tf.app.flags.DEFINE_string('save_name', 'train', 'save name')
tf.app.flags.DEFINE_string('save_dir', '../tfrecord/', 'save name')
tf.app.flags.DEFINE_string('img_format', '.jpg', 'format of image')
tf.app.flags.DEFINE_string('dataset', 'WIDER', 'dataset')
